...
INSERT INTO Copy_Of_Journal (Title, Personal_ID)
       VALUES ('Boken om Niki', '19911011-1047'), 
              ('The Journal of Archaeological Science, vol 4', '19911011-1047'); 
/* Dig */
INSERT INTO Dig( Dig_id, Dig_location, [Date])
       VALUES (  5, 'LKPG',   '2019-03-07'),
              ( 13, 'UME�',   '2021-12-07'), 
              ( 20, 'OSLO',   '2021-12-07'),
              ( 22, 'STHLM',  '2021-12-07'),
              ( 25, 'LKPG',   '2021-12-07'), 
              ( 32, 'KALMAR', '2021-12-07');
/* Literature_Loan */ 
INSERT INTO Literature_Loan ( Personal_ID, Date_out, Date_in, Overdue)
       VALUES ( '19991219-1047', '2019-07-07', '2022-01-06', '2022-01-05'), 
              ('19980313-1047', '2020-09-07', '2022-01-06', '2022-01-05'), 
              ('19951024-1047', '2021-10-07', '2022-01-01', '2022-01-05'), 
              ('19941018-1047', '2021-12-07', '2022-01-01', '2022-01-05'), 
              ('19911011-1047', '2022-01-01', '2022-01-01', '2022-01-05'); 
/* Slide_Loan */
INSERT INTO Slide_Loan (Personal_ID, Date_out, Date_in, Overdue)
       VALUES ( '19991219-1047', '2021-01-05', '2021-03-02', '2021-01-10'), 
              ( '19951024-1047', '2021-01-05', '2021-03-02', '2021-01-10'), 
              ( '19901010-1047', '2021-01-05', '2021-03-02', '2021-01-10'), 
              ( '19901010-1047', '2021-01-05', '2021-03-02', '2021-01-10'), 
              ( '19911011-1047', '2021-01-05', '2021-03-02', '2021-01-10'); 
/* Artifact_Loan */
INSERT INTO Artifact_Loan ( Personal_ID, Date_out, Date_in, Display_Location)
       VALUES ( '19881012-1047', '2021-05-06', '2021-06-05', 'Museum'),
              ( '19881012-1047', '2021-05-06', '2021-06-05', 'Museum'),
              ( '19991219-1047', '2021-05-06', '2021-06-05', 'Museum'),
              ( '19951024-1047', '2021-05-06', '2021-06-05', 'Museum'),
              ( '19951024-1047', '2021-05-06', '2021-06-05', 'Museum');
/* Literature */
...
INSERT INTO Artifact (Item_Nr, Dig_ID, Personal_ID, [Description], Date_Found, Location_Found, Shelf_Nr, Grid, Depth, A_Loan_ID)
       VALUES (1, 5, '19991219-1047', 'En stor vas 1730-talet', '2019-03-07', 'LKPG', '1', '56', 10, 1), 
              (2, 5, '19991219-1047', 'Gaffel i silver', '2019-03-07', 'LKPG', '2', '56', 78, null),
              (3, 5, '19991219-1047', 'Yxa', '2019-03-09', 'LKPG', '3', '56', 78, null),
              (4, 5, '19991219-1047', 'mynt', '2019-03-11', 'LKPG', '4', '56', 78, null),
              (5, 5, '19991219-1047', 'Pil', '2019-03-12', 'LKPG', '5', '56', 78, null),
              (6, 13, '19991219-1047', 'silversked', '2021-05-07', 'UME�', '6', '56', 78, null),
              (7, 13, '19991219-1047', 'Gryta', '2021-05-07', 'UME�', '7', '56', 78, null),
              (8, 13, '19991219-1047', 'En gaffel- vikingatiden', '2021-05-07', 'UME�', '8', '56', 78, 2), 
              (9, 13, '19991219-1047', 'Smycke i guld', '2021-05-07', 'UME�', '9', '56', 78, null),
              ...
              (13, 20, '19991219-1047', 'Kruka i lera', '2021-05-07', 'OSLO', '13', '56', 78, null),
              ...
              (31, 32, '19991219-1047', 'test delete', '2021-05-07', 'KALMAR', '30', '56', 78, null);
